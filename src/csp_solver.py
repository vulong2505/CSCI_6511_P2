...
class CSP:
    ...
    def begin_backtracking(self, select_unassigned_variable=None, order_domain_values=None, inference=None, use_inference=False):
        ...
        # Subfunction backtrack
        def backtrack(assignment=None) -> dict:
            """
            ...
            for value in order_domain_values(var, assignment):
                ...
                if self.is_consistent(var, value, assignment):
                    ...
                    if use_inference:
                        ...
                        # Recurse                
                        if inference(var, assignment, inference_candidates):
